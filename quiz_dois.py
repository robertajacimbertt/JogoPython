...
class Quiz:
    ...
    def __init__(self, master):
        self.master = master
        master.title("Segunda rodada do quiz")
    ...
    def sortearPergunta(self):
        base = open('perguntas_medias.csv', 'r')
        try:
    ...
    def conferirResposta(self, pergunta_sorteada, resposta):
        ...
        if(pergunta_sorteada[indice_resposta_certa] == resposta):
            ...
            if(self.quantidade_de_perguntas_respondidas >= 5):
                ...
                self.master.destroy()
                historia_dois_tela=Tk()
                historia_dois.Historia(historia_dois_tela)
                historia_dois_tela.mainloop()
            else:
